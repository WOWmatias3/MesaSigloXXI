<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MenuEntrada.aspx.cs" Inherits="MesaRestaurant.VistaMenus.MenuEntrada" %>
...
<div class="container-fluid" style="background-color:beige"> 
    ...
    <h1 style="text-align:left;margin-left:30px">Entradas</h1>
    <br />
    ...
    <br /> 
        <div class="row" style="background-color:beige">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM &quot;PLATO&quot; where categoria = 'Entrada' and habilitado = 'Si' and Stock_preparado &gt;0"></asp:SqlDataSource>
        </div>
