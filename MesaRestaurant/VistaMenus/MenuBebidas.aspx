<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MenuBebidas.aspx.cs" Inherits="MesaRestaurant.VistaMenus.MenuBebidas" %>
...
<div class="container-fluid" style="background-color:beige"> 
    ...
    <h1 style="text-align:left;margin-left:30px">Bebidas</h1>
        <br />
    ...
    <br /> 
        ...
        <div class="row" style="background-color:beige">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM &quot;BEBESTIBLE&quot; where habilitado = 'Si' and Stock_bar &gt;0"></asp:SqlDataSource>
        </div>
        ...
        <ItemTemplate >
                <div class="col-sm-12 col-md-6" style="padding:15px; border-style: solid;">
                    ...
                    <div class="col-sm-12 col-md-8" style="vertical-align:central;">
                        <div class="col-sm-12">
                            <asp:HiddenField id="lbCodigo" runat="server" Value ='<%# Eval("ID_BEBESTIBLE") %>'/>
                            <asp:HiddenField ID="HiddenField1" runat="server" />
                        </div>
                        <div class="col-sm-12">
                            <asp:Label ID="NOMBRE_PLATOLabel" runat="server" Text='<%# Eval("NOMBRE_BEB") %>' Font-Size="Medium" Font-Bold="True" Font-Italic="True" />
                        </div>
                        <div class="col-sm-12">
